...
u32 sysctl_mptcp_desired_latency __read_mostly = 1;
EXPORT_SYMBOL(sysctl_mptcp_desired_latency);
...
static struct ctl_table mptcp_table[] = {
	...
	{
		.procname	= "mptcp_desired_latency",
		.data = &sysctl_mptcp_desired_latency,
		.maxlen		= sizeof(u32),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec
	},
